...
class IntegrationPluginHttpCommander : public IntegrationPlugin
{
    ...
    Q_PLUGIN_METADATA(IID "io.nymea.IntegrationPlugin" FILE "integrationpluginhttpcommander.json")
