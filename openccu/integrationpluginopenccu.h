...
private:
    ...
    Thing *gatewayThing(Thing *thing);
    void setGatewayConnected(Thing *gatewayThing, bool connected);
    void setFloorHeatingControllerConnected(Thing *controllerThing, bool connected);
    void updateFloorHeatingValve(Thing *controllerThing, int levelIseId, const QString &levelValue, int levelStatus, int valveState);
